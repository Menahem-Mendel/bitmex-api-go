...
// SchemaConf query parameters for filtering the Schema
type SchemaConf struct {
	Model string `url:"model,omitempty"`
}

// GetSchema returns availiable returned values for particular type
func (c Client) GetSchema(ctx context.Context, f SchemaConf) ([]byte, error) {
	return []byte(""), nil
}
